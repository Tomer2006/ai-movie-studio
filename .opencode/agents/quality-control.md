...
4. **Audio** — If the final mix is silent or wrong, each shot’s clip should carry the audio you want; `assemble` does not add a separate voiceover track — flag bad or missing muxed audio per shot.
